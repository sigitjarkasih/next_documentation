...
import { url_media_local } from "../../../config/api/url";
...
import APIPembeliPengembaliandanaList from "../../../config/api/dokumentasi_pembeli/pengembaliandana/list";
...
export default class Article extends Component {
  ...
  getData = async () => {
    const resp = await APIPembeliPengembaliandanaList({});
    if (resp.status === 200) {
      this.setState({
        data: resp.data,
      });
